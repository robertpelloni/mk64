...
- **Phase 1 Decompilation:** Replaced multiple unnamed `func_800*` audio and action references across `src/audio/`, `src/menus.c`, and actors/items with descriptive, context-aware names.
