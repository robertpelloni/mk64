...
void math_util_unused_8(Mat4, Vec3f, Vec3f);       // Unused
s32 math_util_unused_1(s32, Vec3f, s32, f32, f32); // Unused
s32 render_set_position(Mat4, s32);
f32 dist_squared_bugged(Vec3f, Vec3f);
s32 get_xz_angle_between_points(Vec3f, Vec3f);
u32 math_util_unused_3(Vec3f, Vec3s); // Unused
...
void vec3f_rotate_xyz(Vec3f b, Vec3s rotate); // Unused
void math_util_unused_10(s16, s16, Vec3f);       // Unused
void math_util_unused_5(s16, s16, s32);         // Unused
...
void mtx4_rotate_xyz(Mat4, s16, f32, f32, f32); // Unused
void mtx4_translate_xyz(Mat4, Vec3f, Vec3f);       // Unused
