...
void render_credits_actors(Camera*);
void reset_actor_rotation(Vec3s);
void update_actor_rotation_from_collision(Collision*, Vec3s);
void snap_actor_to_surface(struct Actor*, Vec3f);
void set_player_tyres_active(Player*);
void set_player_tyres_inactive(Player*);
void init_red_shell_texture(void);
void render_actor_with_scale(Vec3f, Vec3s, f32);
void update_and_render_actor_if_valid(struct Actor*, f32);
...
void render_mario_sign(Camera*, Mat4, struct Actor*);
...
// audio/external.c
extern void audio_play_sound_by_pos(Vec3f, Vec3f, u32);
extern void audio_stop_sound_by_pos_and_id_all_cameras(Vec3f, s32);
