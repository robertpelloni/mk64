...
void guMtxF2L(float mf[4][4], Mtx* m) {
    ...
    for (r = 0; r < 4; r++) {
        for (c = 0; c < 2; c++) {
            float f1 = mf[r][2 * c] * 65536.0f;
            float f2 = mf[r][2 * c + 1] * 65536.0f;
            if (f1 > 2147483647.0f) f1 = 2147483647.0f;
            if (f1 < -2147483648.0f) f1 = -2147483648.0f;
            if (f2 > 2147483647.0f) f2 = 2147483647.0f;
            if (f2 < -2147483648.0f) f2 = -2147483648.0f;
            tmp1 = (s32)f1;
            tmp2 = (s32)f2;
