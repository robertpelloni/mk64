...
enum SubMenuSelectionType {
    ...
    SUB_MENU_EXTRAS,
    SUB_MENU_OPTION_MAX = SUB_MENU_EXTRAS, // 0x18 + 1
    SUB_MENU_EXTRAS_MIN = 0x60,
    SUB_MENU_EXTRAS_60FPS = SUB_MENU_EXTRAS_MIN,
    SUB_MENU_EXTRAS_WIDESCREEN,
    SUB_MENU_EXTRAS_FAST_BOOT,
    SUB_MENU_EXTRAS_NO_RUBBER,
    SUB_MENU_EXTRAS_UNLOCK_ALL,
    SUB_MENU_EXTRAS_FLYCAM,
    SUB_MENU_EXTRAS_PROFILER,
    SUB_MENU_EXTRAS_DEBUG,
    SUB_MENU_EXTRAS_DEADZONE,
    SUB_MENU_EXTRAS_MUSIC,
    SUB_MENU_EXTRAS_SFX,
    SUB_MENU_EXTRAS_PRACTICE_MENU,
    SUB_MENU_EXTRAS_CUSTOM_ASSETS,
    SUB_MENU_EXTRAS_RETURN,
    SUB_MENU_EXTRAS_MAX = SUB_MENU_EXTRAS_RETURN,
    SUB_MENU_PRACTICE_MIN = 0x80,
    SUB_MENU_PRACTICE_INPUT_DISPLAY = SUB_MENU_PRACTICE_MIN,
    SUB_MENU_PRACTICE_SPEEDOMETER,
    SUB_MENU_PRACTICE_LEVEL_RESET,
    SUB_MENU_PRACTICE_FLYCAM,
    SUB_MENU_PRACTICE_ITEM_OPTION,
    SUB_MENU_PRACTICE_LAP_SKIP,
    SUB_MENU_PRACTICE_TIMER_FREEZE,
    SUB_MENU_PRACTICE_SAVE_GHOST,
    SUB_MENU_PRACTICE_RETURN,
    SUB_MENU_PRACTICE_MAX = SUB_MENU_PRACTICE_RETURN,
