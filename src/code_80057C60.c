        ...
        if (*huh < lapCount) {
            ...
            if (gModeSelection == (s32) 1) {
                if (D_80165638 >= playerHUD[playerId].someTimer1) {
                    ...
                    audio_play_character_sound(0U, (player->characterId * 0x10) + SOUND_ARG_LOAD(0x29, 0x00, 0x80, 0x0D));
            ...
            *huhthedeuce += 1;
            ...
            switch (*huhthedeuce) { /* switch 1; irregular */
                ...
                case 1: /* switch 1 */
                    ...
                    audio_play_sound_by_player_id(playerId, SOUND_ARG_LOAD(0x19, 0x00, 0xF0, 0x15));
...
void pop_player_balloon(Player* player, s8 playerIndex) {
    if (gPlayerBalloonCount[playerIndex] >= 0) {
        ...
        audio_play_sound_by_player_id(playerIndex, SOUND_ARG_LOAD(0x19, 0x00, 0x90, 0x51));
        if (gPlayerBalloonCount[playerIndex] < 0) {
