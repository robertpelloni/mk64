...
u16 get_sequence_player_state(u8);
void func_800C3608(u8, u8);
u8 check_sequence_player_state(s32);
void func_800C35E8(u8);
void set_channel_volume_scale(u8, u8, u8, u8);
...
void stop_sound_by_player_index(u8, u32);
void play_sound_by_player_index(u8, u32);
void play_character_sound_by_player_index(u8, u32);
void func_800C9250(u8);
void func_800C92CC(u8, u32);
void func_800C94A4(u8);
void play_player_win_sound(u8);
void func_800C98B8(Vec3f, Vec3f, u32);
void func_800C99E0(Vec3f, s32);
void play_race_finish_sound(u8);
void play_race_start_music(u8);
void func_800C9D80(Vec3f, Vec3f, u32);
void func_800C9EF4(Vec3f, u32);
void func_800C9F90(u8);

void fade_and_issue_audio_command(u8, u8);
