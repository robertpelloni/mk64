...
enum MENU_ITEM_TYPE {
    ...
    MENU_ITEM_TYPE_1CD,
    MENU_ITEM_TYPE_1CE,
    MENU_ITEM_EXTRAS_60FPS,
    MENU_ITEM_EXTRAS_WIDESCREEN,
    MENU_ITEM_EXTRAS_FAST_BOOT,
    MENU_ITEM_EXTRAS_NO_RUBBER,
    MENU_ITEM_EXTRAS_UNLOCK_ALL,
    MENU_ITEM_EXTRAS_PROFILER,
    MENU_ITEM_EXTRAS_DEBUG,
    MENU_ITEM_EXTRAS_DEADZONE,
    MENU_ITEM_EXTRAS_MUSIC,
    MENU_ITEM_EXTRAS_SFX,
    MENU_ITEM_EXTRAS_PRACTICE_MENU,
    MENU_ITEM_EXTRAS_CUSTOM_ASSETS,
    MENU_ITEM_EXTRAS_RETURN,
    MENU_ITEM_PRACTICE_INPUT_DISPLAY,
    MENU_ITEM_PRACTICE_SPEEDOMETER,
    MENU_ITEM_PRACTICE_LEVEL_RESET,
    MENU_ITEM_PRACTICE_FLYCAM,
    MENU_ITEM_PRACTICE_SAVE_GHOST,
    MENU_ITEM_PRACTICE_RETURN
};
